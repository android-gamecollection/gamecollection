...
import todo.gamecollection.view.fragment.GameSelection;
import todo.gamecollection.view.fragment.InfoFragment;
import todo.gamecollection.view.fragment.SettingsFragment;
...
public class Hub extends AppCompatActivity {
    ...
    private Fragment getHomeFragment() {
        switch (currentTag) {
            case tagHub:
                return new todo.gamecollection.view.fragment.Hub();
            case tagCards:
