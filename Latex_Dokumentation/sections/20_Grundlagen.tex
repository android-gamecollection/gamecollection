...
Der Activity Lifecycle beschreibt den Lebenszyklus einer Aktivität. Neben den drei Zuständen die eine Aktivität besitzt, beschreibt der Lifecycle auch die Methoden der Klasse \code{Activity}, welche nach belieben überschrieben werden können um bestimmte Statusübergänge zu programmieren.
\begin{figure}[h]
	\centering
