...
erfolgt durch die Nutzung des Interfaces \code{SharedPreferences} in Android.
...
\textbf{ArrayList<Savegame>} gehandhabt. Sobald etwas gespeichert werden soll,
...
String deserialisiert und wieder als \code{ArrayList<Savegame>} benutzt.
...
jeweiligen Spielentwickler selbst gewählt. Das Datum dient der Anzeige und
