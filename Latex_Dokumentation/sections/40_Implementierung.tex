...
Spiele-Kategorien, wie zum Beispiel \emph{Kartenspiele} oder
\emph{Brettspiele}.
...
unterschiedliche Attribute. \code{title} und \code{icon} stimmen mit deren der
Kategorien überein. Ihre Werte kann man beispielsweise in der Spieleliste oder
in der Android-Actionbar sehen. \improvement{More text}
