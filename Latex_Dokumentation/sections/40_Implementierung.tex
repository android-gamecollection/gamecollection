...
Die mit der Hub-Activity verbundenen Fragmente heißen \code{GameCollection} und
...
\begin{lstlisting}[caption={Hub onCreateView() \& onActivityCreated() Methode},
captionpos=b]
@Nullable
@Override
